...
- Cada `expect()` debe tener mensaje de error personalizado usando el segundo argumento de expect: `expect(value, 'mensaje').toBe(expected)` — nunca como segundo argumento del matcher
